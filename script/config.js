export default class Config {
    ...
    this.PIPE_HEIGHT = this.fieldHeight * 4 / 10;
    ...
    this.PIPE_UP_Y = 0;
    this.PIPE_GAP = this.PIPE_WIDTH * 2.5;
    this.PIPE_PADDING = 20;
    ...
    this.BIRD_WIDTH = Math.floor(this.PIPE_WIDTH / 3);
    this.BIRD_HEIGHT = Math.floor(this.PIPE_HOLE / 4);
